...
/// @brief Etcd Service Discovery Filter
class EtcdSelectorFilter : public MessageClientFilter {
 public:
  EtcdSelectorFilter() {
    selector_flow_ = std::make_unique<SelectorWorkFlow>("etcd", true, true);
  }

  ~EtcdSelectorFilter() override {}

  /// @brief initialization
  int Init() override { return selector_flow_->Init(); }

  /// @brief Filter name
  std::string Name() override { return "etcd"; }
